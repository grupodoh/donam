...
?>
    ...
    <body>
        ...
        <div style="margin-top: 70px; display: inline-block;">
            <div class="container">
                <form action="nueva_unidad_medida.php">
                    <button type="submit" class="btn btn-success">+ Nueva Unidad</button>
                </form>
            </div>
        ...
        <div class="container text-center">
            <table class="table">
                <thead>
                    <tr>
                        <th scope="col">ID de la unidad</th>
                ...
                <tbody class="table-group-divider">
                    ...
                    <?php
                    $unidades = getUnidadesMedida($conn);
